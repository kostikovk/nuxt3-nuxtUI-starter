<template>
  <div class="stars w-screen fixed pointer-events-none inset-0 opacity-75">
...
<style scoped lang="scss">
  .stars {
    ...
    mask-image: linear-gradient(180deg, #d9d9d900, #d9d9d9cc 25%, #d9d9d9, #d9d9d9cc 75%, #d9d9d900);
    mask-size: cover;
